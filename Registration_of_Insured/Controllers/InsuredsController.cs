...
namespace Registration_of_Insured.Controllers
{
    public class InsuredsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Surname,Email,TelephoneNumber,Street,HouseNumber,City,ZipCode")] Insured insured)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Surname,Email,TelephoneNumber,Street,HouseNumber,City,ZipCode")] Insured insured)
        {
            if (id != insured.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (insured != null)
            {
                _context.Entry(insured).Collection(i => i.Insurances).Load();
                _context.Insurance.RemoveRange(insured.Insurances);
            }
